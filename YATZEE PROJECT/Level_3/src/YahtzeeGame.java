...
public class YahtzeeGame
{
	...
	*/
	...
	private void markScore()
	{
		...
		do {
			System.out.println("Where would you like to enter a score?(enter a number 1-13): ");
			scoreLocation = s.nextInt();
			s.nextLine();
			allNums+= scoreLocation;

		}while(scoreLocation<=0 || scoreLocation>=14 || allNums.indexOf(scoreLocation)>0);
		switch (scoreLocation){
			case 1: scoreBoard.markOnes(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 2:scoreBoard.markTwos(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 3:scoreBoard.markThrees(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 4:scoreBoard.markFours(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 5:scoreBoard.markFives(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 6:scoreBoard.markSixes(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 7:scoreBoard.markThreeOfAKind(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 8:scoreBoard.markFourOfAKind(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 9:scoreBoard.markFullHouse(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 10:scoreBoard.markSmallStraight(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 11:scoreBoard.markLargeStraight(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 12:scoreBoard.markYahtzee(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
			case 13:scoreBoard.markChance(die1.getValue(),die2.getValue(),die3.getValue(),die4.getValue(),die5.getValue());break;
